...
{
    public partial class frmCeist4 : Form
    {
        
        public Imreoir im;
        public frmCeist4(ref Imreoir imreoir)
        {
        ...
        {
            if (listBox1.SelectedItem == listBox1.Items[3])
            {
                im.Scor += 100;
                im.Scor += Convert.ToInt32(lblAm.Text);
                pictureBox1.Image = Resources.Happy_ye;
                Form clar = new frmCeist5(ref im);
                clar.Show();
                this.Hide();
            }
            else
        ...
        private void frmCeistt4_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            timer1.Start();
