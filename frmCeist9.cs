...
namespace Obair_Chursa_2022
{
    ...
    public partial class frmCeist9 : Form
    {
        public Imreoir im;
        public frmCeist9(ref Imreoir imreoir)
        {
            InitializeComponent();
            this.im = imreoir;
        ...
        private void frmCeist9_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            timer1.Start();
